...
export const getAdminServiceList: QueryFunction<
   ServiceQueryResponse,
   [string, SearchFilter]
> = async ({ queryKey }): Promise<ServiceQueryResponse> => {
   ...
   const res = await axios.get<ServiceQueryResponse>(
      `/api/services/admin?${serviceQuery.toString()}`,
      {
